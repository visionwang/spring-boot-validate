...
import com.yuuyoo.validate.exception.ValidateException;
...
public abstract class AbstractValidateProcessor<C extends ValidateCode> implements ValidateCodeProcessor {
  ...
  @Override
  public C create(ServletWebRequest request) throws Exception {
    C validateCode = generate(request);
    if(validateCodeProperties.getSave().isEnable()){
  ...
  private void save(ServletWebRequest request, C validateCode) {
    ...
    ValidateCodeRepository validateCodeRepository = validateCodeRepositorys.get(validateCodeProperties.getSave().getType().toLowerCase() + ValidateCodeRepository.class.getSimpleName());
